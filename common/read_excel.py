...
if __name__ == '__main__':   # 测试一下自己的代码
    data_list = excel_to_list("../data/test_data.xlsx", "UmsMemberLogin")  # 读取excel，TestUserLogin工作簿的所有数据
    case_data = get_test_data(data_list, 'test_login_success')  # 查找用例'test_user_login_normal'的数据
    print(case_data)